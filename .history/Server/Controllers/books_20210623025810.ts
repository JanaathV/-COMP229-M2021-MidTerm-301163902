...
export function DisplayBookListPage(req: Request, res: Response, next: NextFunction): void
{
    ...
    book.find((err, bookCollection) =>
    {
        ...
        res.render('index', { title: 'Book List', page: 'books', contact: bookCollection});
    });
}
...
export function DisplayEditPage(req: Request, res: Response, next: NextFunction): void
{
    ...
    book.findById(id, {}, {}, (err, bookItemToEdit) => 
    {
        ...
        // show the edit view
        res.render('/Server/Views/books/details.ejs', { title: 'Edit', page: 'details', books: bookItemToEdit});
    });
}
